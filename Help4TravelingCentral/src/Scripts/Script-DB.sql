...
INSERT INTO `categorias` VALUES ('Alojamientos','Alojamientos'),('Habitaciones','Alojamientos'),('Tipo alojamiento','Alojamientos'),('Ubicacion','Alojamientos'),('Automoviles','Automoviles'),('Marca','Automoviles'),('Tarifa','Automoviles'),('Tipo vehiculo','Automoviles'),('Alaska','Cruceros'),('Caribe','Cruceros'),('Cruceros','Cruceros'),('Mar negro','Cruceros'),('Mediterraneo','Cruceros'),('Nilo','Cruceros'),('Air France','Empresas'),('American Airolines','Empresas'),('Iberia','Empresas'),('TAM','Empresas'),('1 ambiente','Habitaciones'),('1 dormitorio','Habitaciones'),('2 dormitorios','Habitaciones'),('Chevrolet','Marca'),('Daihatsu','Marca'),('Fiat','Marca'),('Ford','Marca'),('Peugeot','Marca'),('Economico','Tarifa'),('Full','Tarifa'),('Mini','Tarifa'),('Standar','Tarifa'),('Apartamento','Tipo alojamiento'),('Casa','Tipo alojamiento'),('Hostal','Tipo alojamiento'),('Hotel','Tipo alojamiento'),('Auto','Tipo vehiculo'),('Camion','Tipo vehiculo'),('Camioneta','Tipo vehiculo'),('Moto','Tipo vehiculo'),('First Class','Tipo vuelo'),('LowCost','Tipo vuelo'),('Standar','Tipo vuelo'),('Montaña','Ubicacion'),('Playa','Ubicacion'),('Rural','Ubicacion'),('Empresas','Vuelos'),('Tipo vuelo','Vuelos'),('Vuelos','Vuelos');
